...
export function Course() {
  ...
  return (
    <div>
      <div>
        <img className="pb-[60px] object-fill hidden laptop:block" src="/skill card 1.svg" />
        ...
        <div className="ads h-[488px] mb-[40px] relative">
          <img src="/groupe.png" className="absolute w-[474px] h-auto bottom-[292px] right-[-17px] laptop:hidden" />
